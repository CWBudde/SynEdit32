...
function GetHighlighterFromFileExt(AHighlighters: TStringList;
  Extension: string): TSynEdit32CustomHighlighter;
...
var
  i: integer;
  Highlighter: TSynEdit32CustomHighlighter;
begin
  ...
  begin
    ...
    begin
      if not (AOwner.Components[i] is TSynEdit32CustomHighlighter) then
        continue;
      Highlighter := AOwner.Components[i] as TSynEdit32CustomHighlighter;
...
begin
  ...
  if Assigned(AHighlighters) then
    ...
    begin
      if not (AHighlighters.Objects[i] is TSynEdit32CustomHighlighter) then
        continue;
      Highlighter := TSynEdit32CustomHighlighter(AHighlighters.Objects[i]);
