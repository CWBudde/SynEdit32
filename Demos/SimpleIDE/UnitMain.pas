...
type
  TSimpleIDEMainForm = class(TForm)
    ...
    MenuItemClearBreakpoints: TMenuItem;
    MenuItemDebugGotoCursor: TMenuItem;
    MenuItemDebugPause: TMenuItem;
    MenuItemDebugRun: TMenuItem;
    MenuItemDebugStep: TMenuItem;
    MenuItemDebugStop: TMenuItem;
    MenuItemToggleBreakpoint: TMenuItem;
    N1: TMenuItem;
...
procedure TSimpleIDEMainForm.SynEditorGutterClick(Sender: TObject;
  Button: TMouseButton; X, Y, Line: Integer; Mark: TSynEdit32Mark);
begin
...
begin
  ...
  begin
    ...
    begin
      ...
      FG := clWhite;
      BG := clBlue;
    end else if dlBreakpointLine in LI then
    begin
      Special := TRUE;
      FG := clWhite;
...
begin
  ...
  begin
    ...
    if (FCurrentLine > 0) and (SynEditor.CaretY <> FCurrentLine) then
      SynEditor.CaretXY := SynEdit32BufferCoord(1, FCurrentLine);
    SynEditor.InvalidateGutterLine(FCurrentLine);
    SynEditor.InvalidateLine(FCurrentLine);
  end;
end;
