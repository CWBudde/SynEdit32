object FormSynEdit32Minimap: TFormSynEdit32Minimap
  Left = 393
  Top = 117
  Caption = 'SynEdit32 as MiniMap'
  ClientHeight = 525
  ClientWidth = 1072
  Color = clBtnFace
  ...
  object SynEdit32: TSynEdit32
    ...
    Lines.Strings = (
      ...
      ''
        ...
        ' License.'
      ''
      'The Original Code is: SynEdit32.pas, released 2000-04-07.'
      ...
      ''
        ...
        'Contributors to the SynEdit32 and mwEdit projects are listed in ' +
        'the'
      ...
      ''
      '$Id: SynEdit32.pas,v 1.32 2012/01/05 15:30:39 Egg Exp $'
      ''
      
        'You may retrieve the latest version of this file at the SynEdit3' +
        '2 home page,'
      ...
      ''
        ...
        '----------------------------------------------------------------' +
        '---------------}'
      '//todo: remove SynEdit32 Clipboard Format?'
      ...
      '  QSynEdit32KeyConst,'
      '  QSynEdit32MiscProcs,'
      '  QSynEdit32MiscClasses,'
      '  QSynEdit32TextBuffer,'
      '  QSynEdit32KeyCmds,'
      '  QSynEdit32Highlighter,'
      '  QSynEdit32KbdHandler,'
      '{$ELSE}'
      '  Imm,'
      '  SynTextDrawer,'
      '  SynEdit32Types,'
      '  SynEdit32KeyConst,'
      '  SynEdit32MiscProcs,'
      '  SynEdit32MiscClasses,'
      '  SynEdit32TextBuffer,'
      '  SynEdit32KeyCmds,'
      '  SynEdit32Highlighter,'
      '  SynEdit32KbdHandler,'
      '{$ENDIF}'
      '{$IFDEF UNICODE}'
      '  WideStrUtils,'
      ...
      '  MAX_MARKS = 16;'
      ''
      '  SynEdit32_CLIPBOARD_FORMAT = '#39'SynEdit32 Control Block Type'#39';'
      ''
      'var'
      '  SynEdit32ClipboardFormat: UINT;'
      ''
      'type'
      #9'TBufferCoord = SynEdit32Types.TBufferCoord;'
      #9'TDisplayCoord = SynEdit32Types.TDisplayCoord;'
      ''
      '{$IFDEF SYN_CLX}'
      ...
      ''
        ...
        ');'
      ''
      '  ESynEdit32Error = class(ESynError);'
      ''
      ...
      ''
        ...
        '    var Handled: Boolean; var Command: TSynEdit32orCommand; var ' +
        'AChar: WideChar;'
      ...
      '  TProcessCommandEvent = procedure(Sender: TObject;'
        ...
        '    var Command: TSynEdit32orCommand; var AChar: WideChar; Data:' +
        ' pointer) of object;'
      ''
      ...
      ''
        ...
        '  TSynEdit32CaretType = (ctVerticalLine, ctHorizontalLine, ctHal' +
        'fBlock, ctBlock);'
      ''
      ...
      '    );'
      ''
      '  TSynEdit32orOptions = set of TSynEdit32orOption;'
      ''
      'const'
      
        '  SynEdit32_DEFAULT_OPTIONS = [eoAutoIndent, eoDragDropEditing, ' +
        'eoEnhanceEndKey,'
      ...
      'type'
        ...
        '// use scAll to update a statusbar when another TCustomSynEdit32' +
        ' got the focus'
      ...
      ''
        ...
        '  TSynEdit32MarkList = class(TObjectList)            // It makes' +
        ' more sence to derive from TObjectList,'
      ...
      '  public'
        ...
        '    property Items[Index: Integer]: TSynEdit32Mark read GetItem ' +
      ...
      '{$IFDEF SYN_COMPILER_6_UP}'
        ...
        '  TCustomSynEdit32SearchNotFoundEvent = procedure(Sender: TObjec' +
        't;'
      ...
      '    fRedoList: TSynEdit32UndoList;'
        ...
        '    fBookMarks: array[0..9] of TSynEdit32Mark; // these are just' +
        ' references, fMarkList is the owner'
      '    fMouseDownX: Integer;'
      '    fMouseDownY: Integer;'
      ...
      ''
      '{$IFDEF SYN_CLX}'
      '    FHScrollBar : TSynEdit32ScrollBar;'
      '    FVScrollBar : TSynEdit32ScrollBar;'
      ...
      '    procedure DoTabKey;'
      '    procedure DoCaseChange(const Cmd : TSynEdit32orCommand);'
      ...
      '    function GetOptions: TSynEdit32orOptions;'
      ...
      '    procedure SetOptions(Value: TSynEdit32orOptions);'
      ...
      '      override;'
        ...
        '      var Command: TSynEdit32orCommand; var AChar: WideChar; Dat' +
        'a: pointer); virtual;'
      ...
      '      var Data: pointer): TSynEdit32orCommand;'
      '    procedure UndoItem;'
      ...
      '    procedure ShowCaret;'
        ...
        '    procedure DoOnClearBookmark(var Mark: TSynEdit32Mark); virtu' +
        'al;'
      
        '    procedure DoOnCommandProcessed(Command: TSynEdit32orCommand;' +
        ' AChar: WideChar;'
      ...
      '    procedure DoOnPlaceMark(var Mark: TSynEdit32Mark); virtual;'
        ...
        '    procedure DoOnProcessCommand(var Command: TSynEdit32orComman' +
        'd;'
      ...
      '{$IFDEF SYN_COMPILER_4_UP}'
        ...
        '    procedure AddKey(Command: TSynEdit32orCommand; Key1: word; S' +
        'S1: TShiftState;'
      ...
      '    procedure ClearSelection;'
        ...
        '    procedure CommandProcessor(Command: TSynEdit32orCommand; ACh' +
        'ar: WideChar;'
      '      Data: pointer); virtual;'
      '    procedure ClearUndo;'
      ...
      '{$ENDIF}'
        ...
        '    procedure ExecuteCommand(Command: TSynEdit32orCommand; AChar' +
        ': WideChar;'
      '      Data: pointer); virtual;'
      ...
      '{$ENDIF}'
      '    procedure SetLinesPointer(ASynEdit32: TCustomSynEdit32);'
      ...
      '    property PaintLock: Integer read fPaintLock;'
        ...
        '    property SearchEngine: TSynEdit32SearchCustom read fSearchEn' +
        'gine write SetSearchEngine;'
      ...
      '      read FKeystrokes write SetKeystrokes stored False;'
        ...
        '    property Options: TSynEdit32orOptions read GetOptions write ' +
        'SetOptions'
      '      default SynEdit32_DEFAULT_OPTIONS;'
      
        '    property OverwriteCaret: TSynEdit32CaretType read FOverwrite' +
        'Caret'
      ...
      '{$IFDEF SYN_COMPILER_6_UP}'
        ...
        '    property OnSearchNotFound: TCustomSynEdit32SearchNotFoundEve' +
        'nt'
      ...
      ''
        ...
        'function TCustomSynEdit32.PixelsToNearestRowColumn(aX, aY: Integ' +
        'er): TDisplayCoord;'
      ...
      ''
        ...
        'function TCustomSynEdit32.PixelsToRowColumn(aX, aY: Integer): TD' +
        'isplayCoord;'
      'begin'
      '{$IFDEF SYN_CLX}'
      '  with ClientRect.TopLeft do'
      ...
      ''
        ...
        'function TCustomSynEdit32.RowColumnToPixels(const RowCol: TDispl' +
        'ayCoord): TPoint;'
      'begin'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.DoCopyToClipboard(const SText: Unicod' +
        'eString);'
      '{$IFNDEF SYN_CLX}'
      'var'
      '  Mem: HGLOBAL;'
      ...
      '  fGutterWidth := fGutter.Width;'
        ...
        '  fWordWrapGlyph := TSynGlyph.Create(HINSTANCE, '#39'SynEdit32Wrappe' +
        'd'#39', clLime);'
      ...
      '  fOptions := SynEdit32_DEFAULT_OPTIONS;'
      ...
      '{$IFNDEF SYN_CLX}'
        ...
        'procedure TCustomSynEdit32.CreateParams(var Params: TCreateParam' +
        's);'
      'const'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.InvalidateGutterLines(FirstLine, Last' +
        'Line: integer);'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.InvalidateLines(FirstLine, LastLine: ' +
        'integer);'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.KeyUp(var Key: Word; Shift: TShiftSta' +
        'te);'
      '{$IFDEF SYN_LINUX}'
      'var'
      '  Code: Byte;'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.KeyDown(var Key: Word; Shift: TShiftS' +
        'tate);'
      'var'
      '  Data: pointer;'
      '  C: WideChar;'
      '  Cmd: TSynEdit32orCommand;'
      '  {$IFDEF SYN_LINUX}'
      '  Code: Byte;'
      '  {$ENDIF}'
      'begin'
      ...
      ''
      '{$IFDEF SYN_CLX}'
      'procedure TCustomSynEdit32.DoKeyPressW(var Key: WideChar);'
      'begin'
      ...
      ''
        ...
        'function TCustomSynEdit32.LeftSpaces(const Line: UnicodeString):' +
        ' Integer;'
      'begin'
      ...
      ''
        ...
        'function TCustomSynEdit32.LeftSpacesEx(const Line: UnicodeString' +
      ...
      ''
        ...
        'function TCustomSynEdit32.GetLeftSpacing(CharCount: Integer; Wan' +
        'tTabs: Boolean): UnicodeString;'
      'begin'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.MouseDown(Button: TMouseButton; Shift' +
        ': TShiftState;'
      '  X, Y: Integer);'
      'var'
      '  bWasSel: Boolean;'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.MouseMove(Shift: TShiftState; X, Y: I' +
        'nteger);'
      'var'
      '  P: TDisplayCoord;'
      'begin'
      ...
      '{$ELSE}'
      '    if GetKeyState(SynEdit32_SHIFT) < 0 then'
      '{$ENDIF}'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.MouseUp(Button: TMouseButton; Shift: ' +
        'TShiftState;'
      '  X, Y: Integer);'
      'begin'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.DoOnGutterClick(Button: TMouseButton;' +
        ' X, Y: Integer);'
      'var'
      '  i     : Integer;'
      '  offs  : Integer;'
      ...
      ''
        ...
        '  procedure DrawMark(aMark: TSynEdit32Mark; var aGutterOff: Inte' +
        'ger;'
      '    aMarkRow: Integer);'
      '  begin'
      ...
      '            '#39'SynEdit32InternalImages'#39', 10);'
      '        end;'
      ...
      '// multi-byte chars.'
        ...
        'function TCustomSynEdit32.ExpandAtWideGlyphs(const S: UnicodeStr' +
        'ing): UnicodeString;'
      'var'
      ...
      '// does the opposite of ExpandAtWideGlyphs'
        ...
        'function TCustomSynEdit32.ShrinkAtWideGlyphs(const S: UnicodeStr' +
        'ing; First: Integer;'
      '  var CharCount: Integer): UnicodeString;'
      'var'
      '  i, j: Integer;'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.PaintTextLines(AClip: TRect; const aF' +
        'irstRow, aLastRow,'
      ...
      '    begin'
        ...
        '      sLine := TSynEdit32StringList(Lines).ExpandedStrings[nLine' +
        ' - 1];'
      ...
      '          else'
        ...
        '            fHighlighter.SetRange(TSynEdit32StringList(Lines).Ra' +
        'nges[nLine - 2]);'
      ...
      '    // Check for our special format and read PasteMode.'
        ...
        ' with programs'
      '    // using the ANSI version of SynEdit32.'
      '    //'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.InternalSetCaretXY(const Value: TBuff' +
        'erCoord);'
      'begin'
      '  SetCaretXYEx(True, Value);'
      'end;'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.SetCaretXYEx(CallEnsureCursorPos: Boo' +
        'lean; Value: TBufferCoord);'
      'var'
      '  nMaxX: Integer;'
      ...
      '    // assigned to.'
        ...
        '    // Note to SynEdit32 developers: If this is undesirable in s' +
        'ome obscure'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.SetScrollBars(const Value: TScrollSty' +
        'le);'
      'begin'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.SetSelTextPrimitive(const Value: Unic' +
        'odeString);'
      'begin'
      ...
      '// as we would typically want the cursor to stay where it is.'
        ...
        'procedure TCustomSynEdit32.SetSelTextPrimitiveEx(PasteMode: TSyn' +
        'SelectionMode;'
      ...
      '              // Delete all lines in the selection range.'
        ...
        '            TSynEdit32StringList(Lines).DeleteLines(BB.Line, BE.' +
        'Line - BB.Line);'
      ...
      '        ProperSetLine(CaretY - 1, Str);'
        ...
        '        TSynEdit32StringList(Lines).InsertLines(CaretY, CountLin' +
        'es(P));'
      '      end'
      '      else begin'
      ...
      '          else'
        ...
        '            nMaxScroll := Max(TSynEdit32StringList(Lines).Length' +
        'OfLongestLine, 1);'
      ''
      '          FHScrollBar.Min := 1;'
      ...
      '        else'
        ...
        '          nMaxScroll := Max(TSynEdit32StringList(Lines).LengthOf' +
        'LongestLine, 1);'
      ...
      '{$IFDEF SYN_CLX}'
        ...
        'procedure TCustomSynEdit32.ScrollEvent(Sender: TObject; ScrollCo' +
        'de: TScrollCode; var ScrollPos: Integer);'
      'var'
      ...
      'end;'
      ''
      'function TCustomSynEdit32.GetClientRect: TRect;'
      'begin'
      ...
      'end;'
      ''
      'function TCustomSynEdit32.GetClientOrigin: TPoint;'
      'begin'
      ...
      'end;'
      ''
      'function TCustomSynEdit32.WidgetFlags: Integer;'
      'begin'
      ...
      '{$ELSE}'
      '  if GetKeyState(SynEdit32_CONTROL) < 0 then'
      '{$ENDIF}'
      ...
      '{$IFDEF SYN_CLX}'
        ...
        'procedure TCustomSynEdit32.KeyString(var S: UnicodeString; var H' +
        'andled: Boolean);'
      'var'
      '  i: Integer;'
      'begin'
      ...
      ''
        ...
        'function TCustomSynEdit32.NeedKey(Key: Integer; Shift: TShiftSta' +
        'te;'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.WMGetTextLength(var Msg: TWMGetTextLe' +
        'ngth);'
      'begin'
      '{$IFDEF SYN_COMPILER_4_UP}'
      ...
      '      else'
        ...
        '        LeftChar := TSynEdit32StringList(Lines).LengthOfLongestL' +
        'ine;'
      ...
      '      else'
        ...
        '        iMaxWidth := Max(TSynEdit32StringList(Lines).LengthOfLon' +
        'gestLine, 1);'
      ...
      '  else'
        ...
        '    fHighlighter.SetRange(TSynEdit32StringList(Lines).Ranges[Res' +
        'ult - 1]);'
      ''
      '  repeat'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.ListDeleted(Sender: TObject; aIndex: ' +
        'Integer;'
      '  aCount: Integer);'
      'begin'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.ListInserted(Sender: TObject; Index: ' +
        'Integer;'
      '  aCount: Integer);'
      'var'
      '  L: Integer;'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.ListPutted(Sender: TObject; Index: In' +
        'teger;'
      '  aCount: Integer);'
      'var'
      '  L: Integer;'
      ...
      '      fHighlighter.NextToEol;'
        ...
        '      TSynEdit32StringList(Lines).Ranges[i] := fHighlighter.GetR' +
        'ange;'
      '      Inc(i);'
      '    until i >= Lines.Count;'
      '  end;'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.InsertBlock(const BB, BE: TBufferCoor' +
        'd; ChangeStr: PWideChar;'
      '  AddToUndoList: Boolean);'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.SetBookMark(BookMark: Integer; X: Int' +
        'eger; Y: Integer);'
      'var'
      '  mark: TSynEdit32Mark;'
      'begin'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.ChainListDeleted(Sender: TObject; aIn' +
        'dex: Integer;'
      '  aCount: Integer);'
      'begin'
      ...
      '    fChainListDeleted(Sender, aIndex, aCount);'
        ...
        '  TSynEdit32StringList(fOrigLines).OnDeleted(Sender, aIndex, aCo' +
        'unt);'
      'end;'
      ''
      
        'procedure TCustomSynEdit32.ChainListInserted(Sender: TObject; aI' +
        'ndex: Integer;'
      '  aCount: Integer);'
      'begin'
      ...
      '    fChainListInserted(Sender, aIndex, aCount);'
        ...
        '  TSynEdit32StringList(fOrigLines).OnInserted(Sender, aIndex, aC' +
        'ount);'
      'end;'
      ''
      
        'procedure TCustomSynEdit32.ChainListPutted(Sender: TObject; aInd' +
        'ex: Integer;'
      '  aCount: Integer);'
      'begin'
      ...
      '    fChainListPutted(Sender, aIndex, aCount);'
        ...
        '  TSynEdit32StringList(fOrigLines).OnPutted(Sender, aIndex, aCou' +
        'nt);'
      'end;'
      ''
      ...
      ''
        ...
        'procedure TCustomSynEdit32.HookTextBuffer(aBuffer: TSynEdit32Str' +
        'ingList;'
      '  aUndo, aRedo: TSynEdit32UndoList);'
      'var'
      '  vOldWrap: Boolean;'
      ...
      '  begin'
        ...
        '    iLongestLineLength := TSynEdit32StringList(Lines).LengthOfLo' +
        'ngestLine;'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.SetLinesPointer(ASynEdit32: TCustomSy' +
        'nEdit);'
      'begin'
      '  HookTextBuffer(TSynEdit32StringList(ASynEdit32.Lines),'
      '    ASynEdit32.UndoList, ASynEdit32.RedoList);'
      ''
      '  fChainedEditor := ASynEdit32;'
      '  ASynEdit32.FreeNotification(Self);'
      'end;'
      ''
      ...
      '{$IFDEF SYN_CLX}'
        ...
        'function TCustomSynEdit32.EventFilter(Sender: QObjectH; Event: Q' +
        'EventH): Boolean;'
      'begin'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.DragOver(Source: TObject; X, Y: Integ' +
        'er;'
      ...
      '{$ENDIF}'
        ...
        '    if Dragging then //if the drag source is the SynEdit32 itsel' +
        'f'
      '    begin'
      ...
      '      end;'
      '    end'
      '    else //if is dragging from another SynEdit32'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.DragDrop(Source: TObject; X, Y: Integ' +
        'er);'
      'var'
      '  vNewCaret: TBufferCoord;'
      ...
      '          begin'
      '            if Source <> Self then'
      '              TCustomSynEdit32(Source).SelText := '#39#39
      '            else'
      '            begin'
      '              SelText := '#39#39';'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.SetHighlighter(const Value: TSynCusto' +
        'mHighlighter);'
      'begin'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.SetBorderStyle(Value: TSynBorderStyle' +
        ');'
      'begin'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.SetInsertCaret(const Value: TSynEdit3' +
        '2CaretType);'
      'begin'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.SetOverwriteCaret(const Value: TSynEd' +
        'it32CaretType);'
      'begin'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.EnsureCursorPosVisibleEx(ForceToMiddl' +
        'e: Boolean;'
      '  EvenIfVisible: Boolean = False);'
      'var'
      '  TmpMiddle: Integer;'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.SetKeystrokes(const Value: TSynEdit32' +
        'KeyStrokes);'
      'begin'
      '  if Value = nil then'
      '    FKeystrokes.Clear'
      ...
      ''
        ...
        'function TCustomSynEdit32.TranslateKeyCode(Code: word; Shift: TS' +
        'hiftState;'
      '  var Data: pointer): TSynEdit32orCommand;'
      'var'
      '  i: Integer;'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.CommandProcessor(Command: TSynEdit32o' +
        'rCommand;'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.ExecuteCommand(Command: TSynEdit32orC' +
        'ommand; AChar: WideChar;'
      '  Data: pointer);'
      ''
      ...
      '              Temp := LineText;'
        ...
        '              TabBuffer := TSynEdit32StringList(Lines).ExpandedS' +
        'trings[CaretY - 1];'
      '              Len := Length(Temp);'
      '              Caret := CaretXY;'
      '              vTabTrim := 0;'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.DoOnCommandProcessed(Command: TSynEdi' +
        't32orCommand;'
      '  AChar: WideChar; Data: pointer);'
      'begin'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.DoOnProcessCommand(var Command: TSynE' +
        'ditorCommand;'
      ...
      ''
        ...
        'function TCustomSynEdit32.NextWordPosEx(const XY: TBufferCoord):' +
        ' TBufferCoord;'
      'var'
      ...
      ''
        ...
        'function TCustomSynEdit32.WordStartEx(const XY: TBufferCoord): T' +
        'BufferCoord;'
      'var'
      '  CX, CY: Integer;'
      '  Line: UnicodeString;'
      ...
      ''
        ...
        'function TCustomSynEdit32.WordEndEx(const XY: TBufferCoord): TBu' +
        'fferCoord;'
      'var'
      '  CX, CY: Integer;'
      '  Line: UnicodeString;'
      ...
      ''
        ...
        'function TCustomSynEdit32.PrevWordPosEx(const XY: TBufferCoord):' +
        ' TBufferCoord;'
      'var'
      '  CX, CY: Integer;'
      '  Line: UnicodeString;'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.SetSelectionMode(const Value: TSynSel' +
        'ectionMode);'
      'begin'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.SetActiveSelectionMode(const Value: T' +
        'SynSelectionMode);'
      'begin'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.SetAdditionalIdentChars(const Value: ' +
        'TSysCharSet);'
      'begin'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.SetAdditionalWordBreakChars(const Val' +
        'ue: TSysCharSet);'
      'begin'
      ...
      'end;'
      ''
      'procedure TCustomSynEdit32.AddKey(Command: TSynEdit32orCommand;'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.SetAlwaysShowCaret(const Value: Boole' +
        'an);'
      'begin'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.SetExtraLineSpacing(const Value: Inte' +
        'ger);'
      'begin'
      ...
      ''
        ...
        'function TCustomSynEdit32.GetBookMark(BookMark: Integer; var X, ' +
        'Y: Integer):'
      '  Boolean;'
      'var'
      '  i: Integer;'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.SetSelTextExternal(const Value: Unico' +
        'deString);'
      'var'
      ...
      'end;'
      ''
      'procedure TCustomSynEdit32.SetGutter(const Value: TSynGutter);'
      'begin'
      ...
      ''
      '{$IFNDEF SYN_COMPILER_6_UP}'
      'procedure TCustomSynEdit32.WMMouseWheel(var Msg: TMessage);'
      'var'
      '  nDelta: Integer;'
      ...
      ''
        ...
        'function TCustomSynEdit32.SearchReplace(const ASearch, AReplace:' +
        ' UnicodeString;'
      '  AOptions: TSynSearchOptions): Integer;'
      'var'
      ...
      '  if not Assigned(fSearchEngine) then'
        ...
        '    raise ESynEdit32Error.Create('#39'No search engine has been assi' +
        'gned'#39');'
      ''
      '  Result := 0;'
      ...
      ''
        ...
        'function TCustomSynEdit32.IsPointInSelection(const Value: TBuffe' +
        'rCoord): boolean;'
      'var'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.BookMarkOptionsChanged(Sender: TObjec' +
        't);'
      'begin'
      '  InvalidateGutter;'
      'end;'
      ''
      'function TCustomSynEdit32.GetOptions: TSynEdit32orOptions;'
      'begin'
      '  Result := fOptions;'
      'end;'
      ''
      
        'procedure TCustomSynEdit32.SetOptions(Value: TSynEdit32orOptions' +
        ');'
      'const'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.MoveCaretHorz(DX: Integer; SelectionC' +
        'ommand: Boolean);'
      'var'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.MoveCaretVert(DY: Integer; SelectionC' +
        'ommand: Boolean);'
      'var'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.MoveCaretAndSelection(const ptBefore,' +
      ...
      ''
        ...
        'procedure TCustomSynEdit32.SetCaretAndSelection(const ptCaret, p' +
        'tBefore,'
      '  ptAfter: TBufferCoord);'
      'var'
      '  vOldMode: TSynSelectionMode;'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.HighlighterAttrChanged(Sender: TObjec' +
        't);'
      'begin'
      '  RecalcCharExtent;'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.StatusChanged(AChanges: TSynStatusCha' +
        'nges);'
      'begin'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.DoCaseChange(const Cmd: TSynEdit32orC' +
        'ommand);'
      ''
      ...
      ''
        ...
        'procedure TCustomSynEdit32.InvalidateRect(const aRect: TRect; aE' +
        'rase: Boolean);'
      'begin'
      ...
      '{$IFDEF SYN_COMPILER_4_UP}'
        ...
        'function TCustomSynEdit32.ExecuteAction(Action: TBasicAction): B' +
        'oolean;'
      'begin'
      ...
      ''
        ...
        'function TCustomSynEdit32.UpdateAction(Action: TBasicAction): Bo' +
        'olean;'
      'begin'
      '  if Action is TEditAction then'
      '  begin'
      ...
      ''
        ...
        'function TCustomSynEdit32.DoOnSpecialLineColors(Line: Integer; v' +
        'ar Foreground,'
      ...
      ''
        ...
        'function TCustomSynEdit32.GetMatchingBracketEx(const APoint: TBu' +
        'fferCoord): TBufferCoord;'
      'const'
      ...
      ''
        ...
        'function TCustomSynEdit32.GetHighlighterAttriAtRowCol(const XY: ' +
        'TBufferCoord;'
      ...
      ''
        ...
        'function TCustomSynEdit32.GetHighlighterAttriAtRowColEx(const XY' +
        ': TBufferCoord;'
      ...
      '    else'
        ...
        '      Highlighter.SetRange(TSynEdit32StringList(Lines).Ranges[Po' +
        'sY - 1]);'
      ...
      ''
        ...
        'function TCustomSynEdit32.FindHookedCmdEvent(AHandlerProc: THook' +
        'edCommandEvent): Integer;'
      'var'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.NotifyHookedCommandHandlers(AfterProc' +
        'essing: Boolean;'
      
        '  var Command: TSynEdit32orCommand; var AChar: WideChar; Data: p' +
        'ointer);'
      'var'
      '  Handled: Boolean;'
      '  i: Integer;'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.DoOnClearBookmark(var Mark: TSynEdit3' +
        '2Mark);'
      'begin'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.DoOnPaintTransientEx(TransientType: T' +
        'TransientType; Lock: Boolean);'
      'var'
      '  DoTransient: Boolean;'
      '  i: Integer;'
      'begin'
      ...
      '      for i := 0 to fPlugins.Count - 1 do'
        ...
        '        TSynEdit32Plugin(fPlugins[i]).PaintTransient(Canvas, Tra' +
        'nsientType);'
      '    // event'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.DoOnPaintTransient(TransientType: TTr' +
        'ansientType);'
      'begin'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.DoOnPlaceMark(var Mark: TSynEdit32Mar' +
        'k);'
      'begin'
      ...
      ''
        ...
        'function TCustomSynEdit32.DoOnReplaceText(const ASearch, AReplac' +
        'e: UnicodeString;'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.DoOnStatusChange(Changes: TSynStatusC' +
        'hanges);'
      'begin'
      ...
      ''
        ...
        'function TCustomSynEdit32.GetWordAtRowCol(XY: TBufferCoord): Uni' +
        'codeString;'
      'var'
      '  Line: UnicodeString;'
      '  Len, Stop: Integer;'
      ...
      ''
        ...
        'function TCustomSynEdit32.BufferToDisplayPos(const p: TBufferCoo' +
        'rd): TDisplayCoord;'
      ...
      ''
        ...
        'function TCustomSynEdit32.DisplayToBufferPos(const p: TDisplayCo' +
        'ord): TBufferCoord;'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.DoLinesDeleted(FirstLine, Count: Inte' +
        'ger);'
      'var'
      '  i: Integer;'
      'begin'
      ...
      '    for i := 0 to fPlugins.Count - 1 do'
        ...
        '      TSynEdit32Plugin(fPlugins[i]).LinesDeleted(FirstLine, Coun' +
        't);'
      'end;'
      ''
      
        'procedure TCustomSynEdit32.DoLinesInserted(FirstLine, Count: Int' +
        'eger);'
      'var'
      '  i: Integer;'
      'begin'
      ...
      '    for i := 0 to fPlugins.Count - 1 do'
        ...
        '      TSynEdit32Plugin(fPlugins[i]).LinesInserted(FirstLine, Cou' +
        'nt);'
      'end;'
      ''
      
        'procedure TCustomSynEdit32.PluginsAfterPaint(ACanvas: TCanvas; c' +
        'onst AClip: TRect;'
      '  FirstLine, LastLine: Integer);'
      'var'
      '  i: Integer;'
      ...
      '    for i := 0 to fPlugins.Count - 1 do'
        ...
        '      TSynEdit32Plugin(fPlugins[i]).AfterPaint(ACanvas, AClip, F' +
        'irstLine, LastLine);'
      'end;'
      ''
      
        'procedure TCustomSynEdit32.ProperSetLine(ALine: Integer; const A' +
      ...
      ''
        ...
        'procedure TCustomSynEdit32.RemoveKeyUpHandler(aHandler: TKeyEven' +
        't);'
      'begin'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.RemoveKeyDownHandler(aHandler: TKeyEv' +
        'ent);'
      'begin'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.AddKeyPressHandler(aHandler: TKeyPres' +
        'sWEvent);'
      'begin'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.RemoveKeyPressHandler(aHandler: TKeyP' +
        'ressWEvent);'
      'begin'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.RemoveFocusControl(aControl: TWinCont' +
        'rol);'
      'begin'
      ...
      ''
        ...
        'function TCustomSynEdit32.IsWordBreakChar(AChar: WideChar): Bool' +
        'ean;'
      'begin'
      '  if Assigned(Highlighter) then'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.SetSearchEngine(Value: TSynEdit32Sear' +
        'chCustom);'
      'begin'
      ...
      ''
        ...
        'function TCustomSynEdit32.GetPositionOfMouse(out aPos: TBufferCo' +
        'ord): Boolean;'
      
        '// Get XY caret position of mouse. Returns False if point is out' +
        'side the'
      '// region of the SynEdit32 control.'
      'var'
      '  Point: TPoint;'
      'begin'
        ...
        '  Point := Self.ScreenToClient(Point);    // convert to SynEdit3' +
        '2 coordinates'
      '  { Make sure it fits within the SynEdit32 bounds }'
      ...
      ''
        ...
        'function TCustomSynEdit32.CharIndexToRowCol(Index: Integer): TBu' +
        'fferCoord;'
      ...
      ''
        ...
        'function TCustomSynEdit32.RowColToCharIndex(RowCol: TBufferCoord' +
        '): Integer;'
      '{ Row and Col are 1-based; Result is 0-based }'
      'var'
      '  SynEdit32StringList : TSynEdit32StringList;'
      'begin'
      '  RowCol.Line := Min(Lines.Count, RowCol.Line) - 1;'
      '  SynEdit32StringList := (FLines as TSynEdit32StringList);'
      '  // CharIndexToRowCol assumes a line break size of two'
      '  Result :=  SynEdit32StringList.LineCharIndex(RowCol.Line)'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.WriteRemovedKeystrokes(Writer: TWrite' +
        'r);'
      'var'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.AddMouseDownHandler(aHandler: TMouseE' +
        'vent);'
      'begin'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.RemoveMouseDownHandler(aHandler: TMou' +
        'seEvent);'
      'begin'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.AddMouseUpHandler(aHandler: TMouseEve' +
        'nt);'
      'begin'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.RemoveMouseUpHandler(aHandler: TMouse' +
        'Event);'
      'begin'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.AddMouseCursorHandler(aHandler: TMous' +
        'eCursorEvent);'
      'begin'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.RemoveMouseCursorHandler(aHandler: TM' +
        'ouseCursorEvent);'
      'begin'
      ...
      '{$IFDEF SYN_COMPILER_6_UP}'
        ...
        'procedure TCustomSynEdit32.DoSearchFindFirstExecute(Action: TSea' +
        'rchFindFirst);'
      'begin'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.DoSearchFindExecute(Action: TSearchFi' +
        'nd);'
      'begin'
      '  OnFindBeforeSearch := Action.Dialog.OnFind;'
      '  OnCloseBeforeSearch := Action.Dialog.OnClose;'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.DoSearchReplaceExecute(Action: TSearc' +
        'hReplace);'
      'begin'
      '  OnFindBeforeSearch := Action.Dialog.OnFind;'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.DoSearchFindNextExecute(Action: TSear' +
        'chFindNext);'
      'begin'
      ...
      ''
        ...
        'function TCustomSynEdit32.SearchByFindDialog(FindDialog: TFindDi' +
        'alog) : bool;'
      'var'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.SetInternalDisplayXY(const aPos: TDis' +
        'playCoord);'
      'begin'
      '  IncPaintLock;'
      ...
      ''
        ...
        'procedure TCustomSynEdit32.SetWordWrapGlyph(const Value: TSynGly' +
        'ph);'
      'begin'
      ...
      ''
        ...
        'procedure TSynEdit32MarkList.Notify(Ptr: Pointer; Action: TListN' +
        'otification);'
      'begin'
      '  inherited;'
      '  if Assigned(FOnChange) then'
      ...
      ''
        ...
        'function TSynEdit32MarkList.GetItem(Index: Integer): TSynEdit32M' +
        'ark;'
      'begin'
      ...
      ''
        ...
        'procedure TSynEdit32MarkList.SetItem(Index: Integer; Item: TSynE' +
        'ditMark);'
      'begin'
      ...
      ''
        ...
        'function TSynEdit32MarkList.Extract(Item: TSynEdit32Mark): TSynE' +
        'dit32Mark;'
      'begin'
      ...
      ''
        ...
        'procedure TSynEdit32MarkList.GetMarksForLine(line: Integer; var ' +
        'marks: TSynEdit32Marks);'
      ...
      ''
        ...
        'procedure TSynEdit32Plugin.AfterPaint(ACanvas: TCanvas; const AC' +
        'lip: TRect;'
      '      FirstLine, LastLine: Integer);'
      'begin'
      '  // nothing'
      ...
      ''
        ...
        'procedure TSynEdit32Plugin.PaintTransient(ACanvas: TCanvas; ATra' +
        'nsientType: TTransientType);'
      'begin'
      '  // nothing'
      'end;'
      ''
      
        'procedure TSynEdit32Plugin.LinesInserted(FirstLine, Count: Integ' +
        'er);'
      'begin'
      '  // nothing'
      'end;'
      ''
        ...
        'procedure TSynEdit32Plugin.LinesDeleted(FirstLine, Count: Intege' +
        'r);'
      'begin'
      '  // nothing'
      'end;'
      ...
      '{$ENDIF}'
        ...
        '  SynEdit32ClipboardFormat := RegisterClipboardFormat(SynEdit32_' +
        'CLIPBOARD_FORMAT);'
      '{$ENDIF}'
      ''
      'finalization'
      ...
      ''
      '')
    OnChange = SynEdit32Change
    OnStatusChange = SynEdit32StatusChange
  end
  object SynEdit32MiniMap: TSynEdit32
    Left = 0
    Top = 0
    Width = 150
    Height = 525
    ...
    FontSmoothing = fsmNone
    TabOrder = 1
    OnEnter = SynEdit32MiniMapEnter
    OnMouseUp = SynEdit32MiniMapMouseUp
    BorderStyle = bsNone
    Gutter.Font.Charset = DEFAULT_CHARSET
    ...
    OnSpecialLineColors = SynEdit32MiniMapSpecialLineColors
  end
