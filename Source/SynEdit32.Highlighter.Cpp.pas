...
type
  ...
  TSynCppSyn = class(TSynEdit32CustomHighlighter)
  private
    FAsmStart: Boolean;
    FRange: TRangeState;
...
function TSynCppSyn.GetDefaultAttribute(Index: integer): TSynEdit32HighlighterAttributes;
begin
  case Index of
...
function TSynCppSyn.GetTokenAttribute: TSynEdit32HighlighterAttributes;
begin
  FTokenID := GetTokenID;
  case FTokenID of
