...
type
  ...
  private
    ...
    FHashList: TSynEdit32HashEntryList;
...
{$IFDEF DEBUG}
  public
    property Keywords: TSynEdit32HashEntryList read FHashList;
{$ENDIF}
  public
  ...
  published
    property CommentAttri: TSynEdit32HighlighterAttributes read FCommentAttri
      write FCommentAttri;
    property EventAttri: TSynEdit32HighlighterAttributes read FEventAttri
      write FEventAttri;
    property IdentifierAttri: TSynEdit32HighlighterAttributes read FIdentifierAttri
      write FIdentifierAttri;
    property IncludeAttri: TSynEdit32HighlighterAttributes read FIncludeAttri
      write FIncludeAttri;
    property KeyAttri: TSynEdit32HighlighterAttributes read FKeyAttri write FKeyAttri;
    property NonReservedKeyAttri: TSynEdit32HighlighterAttributes
    ...
    property NumberAttri: TSynEdit32HighlighterAttributes read FNumberAttri
      write FNumberAttri;
    property PreprocessorAttri: TSynEdit32HighlighterAttributes
...
begin
  ...
  FHashList := TSynEdit32HashEntryList.Create;
  ...
  FIncludeAttri := TSynEdit32HighlighterAttributes.Create(SYNS_AttrInclude, SYNS_FriendlyAttrInclude);
