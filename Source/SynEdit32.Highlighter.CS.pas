...
type
  ...
  TSynCSSyn = class(TSynEdit32CustomHighlighter)
  private
    FAsmStart: Boolean;
    FRange: TRangeState;
...
function TSynCSSyn.GetDefaultAttribute(Index: integer): TSynEdit32HighlighterAttributes;
begin
  case Index of
...
function TSynCSSyn.GetTokenAttribute: TSynEdit32HighlighterAttributes;
begin
  case FTokenID of
