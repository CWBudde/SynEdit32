...
type
  TSynBatSyn = class(TSynEdit32CustomHighlighter)
  private
...
function TSynBatSyn.GetDefaultAttribute(Index: integer): TSynEdit32HighlighterAttributes;
begin
  case Index of
...
function TSynBatSyn.GetTokenAttribute: TSynEdit32HighlighterAttributes;
begin
  case FTokenID of
