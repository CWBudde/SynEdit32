...
type
  TSynEdit32ExporterHTML = class(TSynEdit32CustomExporter)
  private
    function AttriToCSS(Attri: TSynEdit32HighlighterAttributes;
      UniqueAttriName: string): string;
    function AttriToCSSCallback(Highlighter: TSynEdit32CustomHighlighter;
      Attri: TSynEdit32HighlighterAttributes; UniqueAttriName: string;
      Params: array of Pointer): Boolean;
    function ColorToHTML(AColor: TColor): string;
    function GetStyleName(Highlighter: TSynEdit32CustomHighlighter;
      Attri: TSynEdit32HighlighterAttributes): string;
    function MakeValidName(Name: string): string;
    function StyleNameCallback(Highlighter: TSynEdit32CustomHighlighter;
      Attri: TSynEdit32HighlighterAttributes; UniqueAttriName: string;
      Params: array of Pointer): Boolean;
  protected
...
{ TSynEdit32ExporterHTML }

constructor TSynEdit32ExporterHTML.Create(AOwner: TComponent);
const
  CF_HTML = 'HTML Format';
begin
...
function TSynEdit32ExporterHTML.AttriToCSS(Attri: TSynEdit32HighlighterAttributes;
  UniqueAttriName: string): string;
var
  StyleName: string;
begin
...
function TSynEdit32ExporterHTML.AttriToCSSCallback(Highlighter: TSynEdit32CustomHighlighter;
  Attri: TSynEdit32HighlighterAttributes; UniqueAttriName: string;
  Params: array of Pointer): Boolean;
var
  Styles: ^string;
...
function TSynEdit32ExporterHTML.ColorToHTML(AColor: TColor): string;
var
  RGBColor: longint;
  RGBValue: byte;
const
...
procedure TSynEdit32ExporterHTML.FormatAfterLastAttribute;
begin
  AddData('</span>');
end;

procedure TSynEdit32ExporterHTML.FormatAttributeDone(BackgroundChanged,
  ForegroundChanged: Boolean; FontStylesChanged: TFontStyles);
begin
  AddData('</span>');
end;

procedure TSynEdit32ExporterHTML.FormatAttributeInit(BackgroundChanged,
  ForegroundChanged: Boolean; FontStylesChanged: TFontStyles);
var
  StyleName: string;
begin
...
procedure TSynEdit32ExporterHTML.FormatBeforeFirstAttribute(BackgroundChanged,
  ForegroundChanged: Boolean; FontStylesChanged: TFontStyles);
var
  StyleName: string;
begin
...
procedure TSynEdit32ExporterHTML.FormatNewLine;
begin
  AddNewLine;
end;

function TSynEdit32ExporterHTML.GetFooter: UnicodeString;
begin
  Result := '';
...
function TSynEdit32ExporterHTML.GetFormatName: string;
begin
  Result := SYNS_ExporterFormatHTML;
end;

function TSynEdit32ExporterHTML.GetHeader: UnicodeString;
const
  DescriptionSize = 105;
  FooterSize1 = 47;
  FooterSize2 = 31;
...
function TSynEdit32ExporterHTML.GetStyleName(Highlighter: TSynEdit32CustomHighlighter;
  Attri: TSynEdit32HighlighterAttributes): string;
begin
  EnumHighlighterAttris(Highlighter, False, StyleNameCallback, [Attri, @Result]);
end;

function TSynEdit32ExporterHTML.MakeValidName(Name: string): string;
var
  i: Integer;
begin
...
function TSynEdit32ExporterHTML.ReplaceReservedChar(AChar: WideChar): UnicodeString;
begin
  case AChar of
    '&': Result := '&amp;';
    '<': Result := '&lt;';
...
function TSynEdit32ExporterHTML.StyleNameCallback(Highlighter: TSynEdit32CustomHighlighter;
    Attri: TSynEdit32HighlighterAttributes; UniqueAttriName: string;
    Params: array of Pointer): Boolean;
var
...
function TSynEdit32ExporterHTML.UseBom: Boolean;
begin
  // do not include seUTF8 as some browsers have problems with UTF-8-BOM
  Result := Encoding in [seUTF16LE, seUTF16BE];
end;

function TSynEdit32ExporterHTML.SupportedEncodings: TSynEncodings;
begin
