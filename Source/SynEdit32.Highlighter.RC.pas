...
type
 ...
 TSynRCSyn = class(TSynEdit32CustomHighlighter)
  private
   FRange: TRangeState;
...
function TSynRCSyn.GetDefaultAttribute(Index: Integer): TSynEdit32HighlighterAttributes;
begin
  case Index of
...
function TSynRCSyn.GetTokenAttribute: TSynEdit32HighlighterAttributes;
begin
  case FTokenID of
