...
uses
  Windows, Messages, Graphics, Controls, Forms, Dialogs, SysUtils, Classes,
  SynEdit32, SynEdit32.KeyCmds, SynEdit32.Unicode;
...
procedure TSynEdit32PythonBehaviour.doProcessUserCommand(Sender: TObject;
...
begin
  ...
  begin
    iEditor := Sender as TCustomSynEdit32;
...
constructor TSynEdit32PythonBehaviour.Create(aOwner: TComponent);
begin
