...
CONTENTS:
  ...
  Run-time methods
    ...
    Assign   : Assign values from another TSynEdit32PrintMargins object.
...
uses
  ...
  Classes,
  SysUtils,
  SynEdit32.PrintTypes,
  SynEdit32.PrinterInfo,
  SynEdit32.Unicode;

type
  //Margins class - sorting out dimensions of printable area
  TSynEdit32PrintMargins = class(TPersistent)
  private
  ...
  public
    ...
    procedure InitPage(ACanvas: TCanvas; PageNum: Integer;
      PrinterInfo: TSynEdit32PrinterInfo; LineNumbers,
...
{ TSynEdit32PrintMargins }
const
  mmPrInch = 25.4;
  mmPrCm = 10;

constructor TSynEdit32PrintMargins.Create;
begin
  inherited;
  FUnitSystem := usMM;
  FLeft := DefLeft;
...
function TSynEdit32PrintMargins.ConvertTo(Value: Double): Double;
{Convert Value to mm}
begin
  case FUnitSystem of
...
function TSynEdit32PrintMargins.ConvertFrom(Value: Double): Double;
...
function TSynEdit32PrintMargins.GetBottom: Double;
begin
  Result := ConvertFrom(FBottom);
end;

function TSynEdit32PrintMargins.GetFooter: Double;
begin
  Result := ConvertFrom(FFooter);
end;

function TSynEdit32PrintMargins.GetGutter: Double;
begin
  Result := ConvertFrom(FGutter);
end;

function TSynEdit32PrintMargins.GetHeader: Double;
begin
  Result := ConvertFrom(FHeader);
end;

function TSynEdit32PrintMargins.GetLeft: Double;
begin
  Result := ConvertFrom(FLeft);
end;

function TSynEdit32PrintMargins.GetRight: Double;
begin
  Result := ConvertFrom(FRight);
end;

function TSynEdit32PrintMargins.GetTop: Double;
begin
  Result := ConvertFrom(FTop);
end;

function TSynEdit32PrintMargins.GetLeftHFTextIndent: Double;
begin
  Result := ConvertFrom(FLeftHFTextIndent);
end;

function TSynEdit32PrintMargins.GetRightHFTextIndent: Double;
begin
  Result := ConvertFrom(FRightHFTextIndent);
end;

function TSynEdit32PrintMargins.GetHFInternalMargin: Double;
begin
  Result := ConvertFrom(FHFInternalMargin);
end;

procedure TSynEdit32PrintMargins.SetBottom(const Value: Double);
begin
  FBottom := ConvertTo(Value);
end;

procedure TSynEdit32PrintMargins.SetFooter(const Value: Double);
begin
  FFooter := ConvertTo(Value);
end;

procedure TSynEdit32PrintMargins.SetGutter(const Value: Double);
begin
  FGutter := ConvertTo(Value);
end;

procedure TSynEdit32PrintMargins.SetHeader(const Value: Double);
begin
  FHeader := ConvertTo(Value);
end;

procedure TSynEdit32PrintMargins.SetLeft(const Value: Double);
begin
  FLeft := ConvertTo(Value);
end;

procedure TSynEdit32PrintMargins.SetRight(const Value: Double);
begin
  FRight := ConvertTo(Value);
end;

procedure TSynEdit32PrintMargins.SetTop(const Value: Double);
begin
  FTop := ConvertTo(Value);
end;

procedure TSynEdit32PrintMargins.SetLeftHFTextIndent(const Value: Double);
begin
  FLeftHFTextIndent := ConvertTo(Value);
end;

procedure TSynEdit32PrintMargins.SetRightHFTextIndent(const Value: Double);
begin
  FRightHFTextIndent := ConvertTo(Value);
end;

procedure TSynEdit32PrintMargins.SetHFInternalMargin(const Value: Double);
begin
...
procedure TSynEdit32PrintMargins.InitPage(ACanvas: TCanvas; PageNum: Integer;
  PrinterInfo: TSynEdit32PrinterInfo; LineNumbers, LineNumbersInMargin: Boolean;
  MaxLineNum: Integer);
...
// -----------------------------------------------------------------------------
// Assign values from another TSynEdit32PrintMargins object
procedure TSynEdit32PrintMargins.Assign(Source: TPersistent);
var
  Src: TSynEdit32PrintMargins;
begin
  if (Source <> nil) and (Source is TSynEdit32PrintMargins) then begin
    Src := TSynEdit32PrintMargins(Source);
    FLeft := Src.FLeft;
    FRight := Src.FRight;
    FTop := Src.FTop;
    FBottom := Src.FBottom;
...
procedure TSynEdit32PrintMargins.LoadFromStream(AStream: TStream);
begin
...
procedure TSynEdit32PrintMargins.SaveToStream(AStream: TStream);
begin
