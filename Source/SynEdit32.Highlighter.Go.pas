...
type
  TSynGoSyn = class(TSynEdit32CustomHighlighter)
  private
    fRange: TRangeState;
...
function TSynGoSyn.GetDefaultAttribute(Index: Integer): TSynEdit32HighlighterAttributes;
begin
  case Index of
...
function TSynGoSyn.GetTokenAttribute: TSynEdit32HighlighterAttributes;
begin
  case GetTokenID of
    tkComment:
