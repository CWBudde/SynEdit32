...
type
  ...
  private
    ...
    FPrinterInfo: TSynEdit32PrinterInfo;
    FPages: TList;
    FCanvas: TCanvas;
    FCharWidth: Integer;
    ...
    procedure SetSynEdit(const Value: TCustomSynEdit32);
    procedure SetFooter(const Value: TFooter);
    procedure SetHeader(const Value: THeader);
    procedure SetMargins(const Value: TSynEdit32PrintMargins);
  ...
  public
    ...
    property PrinterInfo: TSynEdit32PrinterInfo read FPrinterInfo;
    property PageCount: Integer read GetPageCount;
    property SynEdit: TCustomSynEdit32 write SetSynEdit;
  ...
  published
    ...
    property Margins: TSynEdit32PrintMargins read FMargins write SetMargins;
...
begin
  ...
  FPrinterInfo := TSynEdit32PrinterInfo.Create;
  FFont := TFont.Create;
...
begin
  ...
  SynEdit32.Unicode.TextOut(FCanvas, FMargins.PLeft - TextWidth(FCanvas, AStr), FYPos, AStr);
  RestoreCurrentFont;
end;
