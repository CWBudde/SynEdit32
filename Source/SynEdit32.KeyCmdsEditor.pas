...
uses
  ...
  UITypes,
  {$ENDIF}
  Windows, Messages, Graphics, Controls, Forms, Dialogs, ComCtrls, Menus,
  StdCtrls, Buttons, ExtCtrls, SysUtils, Classes,
  SynEdit32.KeyCmds;
...
var
  ...
  begin
    ...
    begin
      ...
      try
        KeyLoc := TSynEdit32Keystrokes(NewStroke.Collection).FindShortcut2(AForm.Keystroke, AForm.Keystroke2);
        ...
        on ESynKeyError do
          begin
            ...
            if FExtended then
              TmpCommand := ConvertCodeStringToExtended(EditorCommandToCodeString(TSynEdit32Keystrokes(NewStroke.Collection).Items[KeyLoc].Command))
            else TmpCommand := EditorCommandToCodeString(TSynEdit32Keystrokes(NewStroke.Collection).Items[KeyLoc].Command);
...
var
  ...
  begin
    ...
    begin
      ...
      try
        KeyLoc := TSynEdit32Keystrokes(FKeystrokes[SelItem.Index].Collection).FindShortcut2(AForm.Keystroke, AForm.Keystroke2);
        ...
        on ESynKeyError do
          begin
            // Shortcut already exists in the collection!
            if FExtended then
              TmpCommand := ConvertCodeStringToExtended(EditorCommandToCodeString(TSynEdit32Keystrokes(FKeystrokes[SelItem.Index].Collection).Items[KeyLoc].Command))
            else TmpCommand := EditorCommandToCodeString(TSynEdit32Keystrokes(FKeystrokes[SelItem.Index].Collection).Items[KeyLoc].Command);
