...
uses
  ...
  UITypes,
  {$ENDIF}
  Windows, Messages, Graphics, Menus, Controls, Forms, Dialogs, StdCtrls,
  ComCtrls, ExtCtrls, SysUtils, Classes,
  SynEdit32.KeyCmds,
...
type
  ...
  public
    hkKeystroke2: TSynEdit32HotKey;
    hkKeystroke: TSynEdit32HotKey;
...
begin    
  hkKeystroke := TSynEdit32HotKey.Create(self);
  with hkKeystroke do
  begin
    Parent := pnlAlign;
    Left := 65;
  ...
  hkKeystroke2 := TSynEdit32HotKey.Create(self);
