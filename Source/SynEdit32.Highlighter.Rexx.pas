...
unit SynEdit32.Highlighter.Rexx;
...
type
  TSynRexxSyn = class(TSynEdit32CustomHighlighter)
  private
    fRange: TRangeState;
    ...
    fStdFunctionAttri: TSynEdit32HighlighterAttributes;
  ...
  published
    ...
    property SpecialAttri: TSynEdit32HighlighterAttributes read fSpecialAttri write fSpecialAttri;
    property StdFunctionAttri: TSynEdit32HighlighterAttributes read fStdFunctionAttri write fStdFunctionAttri;
...
begin
  ...
  fSpecialAttri := TSynEdit32HighlighterAttributes.Create(SYNS_AttrSpecial, SYNS_FriendlyAttrSpecial);
  fSpecialAttri.Foreground := clAqua    ;
  AddAttribute(fSpecialAttri);

  fStdFunctionAttri := TSynEdit32HighlighterAttributes.Create(SYNS_AttrStdFunction, SYNS_FriendlyAttrStdFunction);
...
function TSynRexxSyn.GetDefaultAttribute(Index: Integer): TSynEdit32HighlighterAttributes;
begin
  case Index of
...
function TSynRexxSyn.GetTokenAttribute: TSynEdit32HighlighterAttributes;
begin
  case GetTokenID of
